...
class CustomEncryptor {
	...
	public static void main(String args[]) {
		...
		CustomEncryptor c = new CustomEncryptor();

		//create public and private keys (send private to clients)
		c.setPrivateKey("RSApriv.der");
		c.setPublicKey("RSApub.der");

		//secretkey is generated by client	
		...
		//encrypt plaintext bytes using secret key and iv
		...
		//decrypt secretkey bytes
		byte decryptedsecret[] = c.RSADecrypt(encryptedsecret);

		//construct secretkey with decrypted bytes bytes
